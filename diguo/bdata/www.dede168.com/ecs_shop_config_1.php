...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','生鲜商城','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ecshop生鲜食品蔬菜水果微信分销商城网站模板+手机wap+微信支付','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ecshop生鲜食品蔬菜水果微信分销商城网站模板+手机wap+微信支付','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ecshop生鲜食品蔬菜水果微信分销商城网站模板+手机wap+微信支付','1');");
E_D("replace into `ecs_shop_config` values('105','1','shop_country','manual','','','1','1');");
E_D("replace into `ecs_shop_config` values('106','1','shop_province','manual','','','10','1');");
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','147','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','三段9号','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','123456','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','o菜龙','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','123456@qq.com','1');");
...
E_D("replace into `ecs_shop_config` values('118','1','shop_logo','file','','../themes/{\$template}/images/','../themes/lizi/images/logo.gif','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','冀ICP12345678号','1');");
...
E_D("replace into `ecs_shop_config` values('229','2','default_storage','text','','','9999','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','1089132730','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','1d825bf072672566d6961b48d26b44378a5aff73417223d90a4a43327b17bfdc','1');");
...
E_D("replace into `ecs_shop_config` values('304','3','thumb_width','text','','','400','1');");
E_D("replace into `ecs_shop_config` values('305','3','thumb_height','text','','','400','1');");
...
E_D("replace into `ecs_shop_config` values('319','3','page_size','text','','','11','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','宠物狗粮,鸟笼，磨牙棒,国产料,遛狗绳','0');");
...
E_D("replace into `ecs_shop_config` values('603','6','hash_code','hidden','','','2aab9f77cc5ab4694b2b6009f5785883','1');");
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','lizi','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1447726949','1');");
...
E_D("replace into `ecs_shop_config` values('90','0','ecsdxt','group','','','','1');");
E_D("replace into `ecs_shop_config` values('9001','90','ecsdxt_gateway','options','1,2','','1','1');");
E_D("replace into `ecs_shop_config` values('9002','90','ecsdxt_user_name','text','','','kkkkaaa','1');");
E_D("replace into `ecs_shop_config` values('9003','90','ecsdxt_pass_word','password','','','','1');");
E_D("replace into `ecs_shop_config` values('9004','90','ecsdxt_shop_mobile','text','','','13000000007','1');");
E_D("replace into `ecs_shop_config` values('9005','90','ecsdxt_smsgap','text','','','10','1');");
E_D("replace into `ecs_shop_config` values('9006','90','ecsdxt_mobile_reg','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9007','90','ecsdxt_mobile_reg_value','textarea','','','您的手机号：{\$user_mobile}，注册验证码：{\$verify_code}，一天内提交有效。感谢您的注册！','1');");
E_D("replace into `ecs_shop_config` values('9008','90','ecsdxt_mobile_log','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9009','90','ecsdxt_mobile_pwd','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9010','90','ecsdxt_mobile_pwd_value','textarea','','','您的用户名：{\$user_name}，新密码：{\$new_password}。请及时登陆修改密码！','1');");
E_D("replace into `ecs_shop_config` values('9011','90','ecsdxt_mobile_changepwd','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9012','90','ecsdxt_mobile_changepwd_value','textarea','','','您的用户名：{\$user_name}，密码已修改，新密码：{\$new_password}。请牢记新密码！','1');");
E_D("replace into `ecs_shop_config` values('9013','90','ecsdxt_mobile_bind','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9014','90','ecsdxt_mobile_bind_value','textarea','','','您的手机号：{\$user_mobile}，绑定验证码：{\$verify_code}。一天内提交有效！','1');");
E_D("replace into `ecs_shop_config` values('9015','90','ecsdxt_mobile_cons','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9016','90','ecsdxt_customer_registed','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9017','90','ecsdxt_customer_registed_value','textarea','','','您注册的用户名：{\$user_name}，密码：{\$user_pwd}。感谢您的注册！','1');");
E_D("replace into `ecs_shop_config` values('9018','90','ecsdxt_order_placed','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9019','90','ecsdxt_order_placed_value','textarea','','','您有新的订单：{\$order_sn}，收货人：{\$consignee}，电话：{\$tel}，请及时确认订单！','1');");
E_D("replace into `ecs_shop_config` values('9020','90','ecsdxt_order_canceled','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9021','90','ecsdxt_order_canceled_value','textarea','','','订单号 ：{\$order_sn} 买家已取消订单！','1');");
E_D("replace into `ecs_shop_config` values('9022','90','ecsdxt_order_payed','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9023','90','ecsdxt_order_payed_value','textarea','','','订单号 ：{\$order_sn} 买家付款了。收货人：{\$consignee}，电话：{\$tel}。请及时安排发货！','1');");
E_D("replace into `ecs_shop_config` values('9024','90','ecsdxt_order_confirm','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9025','90','ecsdxt_order_confirm_value','textarea','','','订单号 ：{\$order_sn} 买家已确认收货！','1');");
E_D("replace into `ecs_shop_config` values('9026','90','ecsdxt_customer_placed','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9027','90','ecsdxt_customer_placed_value','textarea','','','您的订单：{\$order_sn}，收货人：{\$consignee} 电话：{\$tel}，已经成功提交。感谢您的购买！','1');");
E_D("replace into `ecs_shop_config` values('9028','90','ecsdxt_customer_canceled','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9029','90','ecsdxt_customer_canceled_value','textarea','','','您的订单：{\$order_sn}，已取消！','1');");
E_D("replace into `ecs_shop_config` values('9030','90','ecsdxt_customer_payed','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9031','90','ecsdxt_customer_payed_value','textarea','','','您的订单：{\$order_sn}，已于{\$time}付款成功。感谢您的购买！','1');");
E_D("replace into `ecs_shop_config` values('9032','90','ecsdxt_customer_confirm','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9033','90','ecsdxt_customer_confirm_value','textarea','','','您的订单：{\$order_sn}，确认收货成功。感谢您购买与支持，欢迎您下次光临！','1');");
E_D("replace into `ecs_shop_config` values('9034','90','ecsdxt_order_picking','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9035','90','ecsdxt_order_picking_value','textarea','','','订单号：{\$order_sn} 已于{\$time}配货。如有问题请及时联系！','1');");
E_D("replace into `ecs_shop_config` values('9036','90','ecsdxt_order_shipped','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9037','90','ecsdxt_order_shipped_value','textarea','','','订单号：{\$order_sn} 已于{\$time}发货，如有问题请及时联系！','1');");
E_D("replace into `ecs_shop_config` values('9038','3','show_sales_type','select','1,0','','0','1');");
