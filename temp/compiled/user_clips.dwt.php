...
<link href="themes/lizi/user.css" rel="stylesheet" type="text/css" />
     ...
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%; font-size:14px;">
         ...
         <?php if ($this->_var['action'] == 'default'): ?>
          ...
          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#f70;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
           <?php endif; ?>
           <div style="margin:5px 0; border:1px solid #ddd;padding:10px 20px; background-color:#ffe9da;">
           <img src="themes/lizi/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
           </div>
           <br /><br />
          <div class="f_l" style="width:350px;">
          <h5><span><?php echo $this->_var['lang']['your_account']; ?></span></h5>
          <div class="blank"></div>
          <?php echo $this->_var['lang']['your_surplus']; ?>:<a href="user.php?act=account_log" style="color:#f70;"><?php echo $this->_var['info']['surplus']; ?></a><br />
          <?php if ($this->_var['info']['credit_line'] > 0): ?>
          <?php echo $this->_var['lang']['credit_line']; ?>:<?php echo $this->_var['info']['formated_credit_line']; ?><br />
          <?php endif; ?>
          <?php echo $this->_var['lang']['your_bonus']; ?>:<a href="user.php?act=bonus" style="color:#f70;"><?php echo $this->_var['info']['bonus']; ?></a><br />
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/lizi/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
    <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/lizi/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php else: ?>
