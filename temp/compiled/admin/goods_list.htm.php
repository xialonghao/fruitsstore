...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <?php endif; ?>
	<th><a href="javascript:listTable.sort('sales_volume_base'); "><?php echo $this->_var['lang']['sales_volume_base']; ?></a><?php echo $this->_var['sort_sales_volume_base']; ?></th>
...
?>
  <tr>
    ...
    <td align="center">
      ...
      <?php if ($this->_var['specifications'] [ $this->_var['goods']['goods_type'] ] != ''): ?><a href="product_spec_pic.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['lang']['specification_pic']; ?>"><img src="images/guigou_icon.png" width="16" height="16" border="0" /></a><?php else: ?><img src="images/empty.gif" width="16" height="16" border="0" /><?php endif; ?>
