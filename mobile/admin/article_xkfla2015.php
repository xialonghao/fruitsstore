 ...
 * O菜龙工作室（www.ocailong.com）开发单品推广管理页面
...
require_once(ROOT_PATH . 'include/cls_image_xkfla.php');
...

{
    ...
    $smarty->assign('action_link',  array('text' => "添加推广单品页面", 'href' => 'article_xkfla2015.php?act=add'));
    ...
    $smarty->display('article_list_xkfla2015.htm');
...

{
    ...
    $smarty->assign('action_link', array('text' => "查看正在推广的单品", 'href' => 'article_xkfla2015.php?act=list'));
    ...
    $smarty->display('article_info_xkfla2015.htm');
...

{
    ...
    $link[1]['href'] = 'article_xkfla2015.php?act=list';
...

{
...

    {
        ...
        $link[0]['href'] = 'article_xkfla2015.php?act=list&' . list_link_postfix();
